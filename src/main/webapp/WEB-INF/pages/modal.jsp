							...
							$.ajax({
									...
									success : function(response) {
															...
															columns : [
																	...
																	},
																	{
																		...
																		"fnCreatedCell" : function(data) {
																			$(data).html("<input type='button' class='btn btn-warning' data-toggle='modal' data-target='#myModal' value='edit'>&nbsp;&nbsp;<input type='button' value='Delete' class='btn btn-danger' data-toggle='modal' data-target='#myModal1' value='delete'>");
																			/* &nbsp;&nbsp;<input type='button' class='btn btn-danger delete' id='delete' onclick='deletes()' value='delete'>" */
																		}														
																	},
										...
										$('#prjView tbody').on('click', '.btn-warning', function () {
								              ...
								              var zipcode = $(this).closest('tr').find('td:eq(7)').text();
								              var gender = $(this).closest('tr').find('td:eq(8)').text();
								              var team = $(this).closest('tr').find('td:eq(9)').text();
							            ...
							            $('#prjView tbody').on('click', '.btn-danger', function () {
							                var name = $(this).closest('tr').find('td:eq(2)').text();
							                                      $(document).ready(function() {
							                	                                                  swal({
							                	                                                        title: "Are you sure?",
